...
> This is a class with some methods, but you will do it by doing test-driven development (TDD)
...
- Git clone `https://github.com/aceDavon/tdd---project.git`
- cd `tdd---project`
- run `bundle install`
- run `rubocop .` to check for linters
- run `ruby tdd---project.rb` to run program
